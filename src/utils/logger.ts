...
class Logger {
  ...
  private get level(): LogLevel {
    const globalLevel = Logger.globalLevel;
    const envLevel = process.env.LOG_LEVEL?.toUpperCase();
    return this.parseLevel(globalLevel || envLevel) ?? LogLevel.INFO;
  }
  ...
  private static globalLevel: 'DEBUG' | 'INFO' | 'WARN' | 'ERROR' | undefined;
